...
![输入到交付](assets/readme-examples/01-input-to-delivery.png)

### 信息筛选

![信息筛选](assets/readme-examples/02-signal-filter.png)

### 产品验证

![产品验证](assets/readme-examples/03-product-validation.png)

### 内容复利

![内容复利](assets/readme-examples/04-content-compound.png)

### 信任建立

![信任建立](assets/readme-examples/05-trust-bridge.png)

### 一人公司

![一人公司](assets/readme-examples/06-solo-company.png)
...
- 历史示例图不作为生成依据；当前 IP 以 `codeartz-illustrations/assets/ip/codeartz-ai-cat-reference.png` 为准。
